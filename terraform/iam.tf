# IAM Role for CodeBuild with full admin access
...
# IAM Role for CodePipeline with full admin access
...
# IAM Role for ECS Task Execution with full access
...
# Using full admin access as requested
